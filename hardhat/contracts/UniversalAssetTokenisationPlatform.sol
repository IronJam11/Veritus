...
contract UniversalAssetTokenizationPlatform is ERC721Holder, ReentrancyGuard {
    ...
    function createAsset( 
        ...
        if(creatorSharesPercent > 9000 || creatorSharesPercent < 1000) revert InvalidInput();
        ...
        // No IP ID or license terms in this version
        address ipId = address(0);
        uint256 licenseTermsId = 0;
